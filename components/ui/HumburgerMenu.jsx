    ...
    >
      <div className="relative flex overflow-hidden items-center justify-center rounded-full w-[50px] h-[50px] transform transition-all duration-200">
        <div className="flex flex-col justify-between w-[24px] h-[20px] transform transition-all duration-300 origin-center overflow-hidden">
          <div
            className={`bg-text dark:bg-text-bg-dark h-[2px] w-8 transform transition-all duration-300 origin-left ${
              humburgerMenu ? "translate-x-10" : ""
            }`}
          ></div>
          <div
            className={`bg-text dark:bg-text-bg-dark h-[2px] w-8 rounded transform transition-all duration-300 ${
              humburgerMenu ? "translate-x-10" : ""
            } delay-75`}
          ></div>
          <div
          ...
          >
            <div
              className={`absolute bg-text dark:bg-text-bg-dark h-[2px] w-6 transform transition-all duration-500 rotate-0 delay-300 ${
