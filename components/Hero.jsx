...
const Hero = () => {
  return (
    <section className="w-full mx-auto mt-24">
      <div className="w-full flex bg-[#2ca4ab] py-5 px-4 md:px-8 rounded-2xl justify-between items-center">
        <div className="w-full md:w-7/12 ">
          <h2 className="font-bold text-3xl md:text-5xl text-white-blue">Selamat Datang di Aplikasi Qur'an Portal</h2>
        ...
        <Image
          src="/logo/qurankarim.png"
          alt="Al-Quran Al-Karim"
          priority
          width={350}
          height={350}
