...
const Navbar = ({ className = "fixed" }) => {
  ...
  return (
    <>
      <nav
        className={`${className} top-0 left-0 w-full bg-white text-text dark:bg-soft-dark dark:text-text-bg-dark py-2 lg:py-4 shadow z-50`}
      >
        <div className="w-full mx-auto container px-3 md:px-6 lg:px-16 flex items-center justify-between">
          <div className="lg:w-3/12">
            <a href="/">
              <h2 className="font-fair font-extrabold text-transparent text-[26px] bg-clip-text bg-primary dark:text-text-bg-dark">
                Quran Portal
              </h2>
            </a>
          </div>
          ...
          <HumburgerMenu
            ...
            setHumburgerMenu={setHumburgerMenu}
          />
